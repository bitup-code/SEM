...
public class TodoDaoImpl implements TodoDao {
	...
	public void insertTodo(Todo todo) throws SQLException {
		...
		try (Connection connection = JDBCUtils.getConnection();//достает конект  JDBCUtils и в тот конект  и  него достает стейтмент скрамлевает параметры которые подставляются место знака вопрос
